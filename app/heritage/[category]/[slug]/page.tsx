...
export default function SpecimenRecordPage({ params }: SpecimenPageProps) {
  ...
  // Parse the markdown file matching this dynamic path
  ...
  return (
    <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 bg-[#F9F9F7] min-h-screen text-[#1C1C1A]">
      {/* Back to main Repository / Heritage view */}
      <div className="mb-12">
        <Link 
          href="/heritage" 
      ...
      {/* Grid Layout Framework Split */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
        
        {/* LEFT COLUMN: Narrative & Prose Description (7 Columns) */}
        <div className="lg:col-span-7 flex flex-col space-y-8">
          ...
          {/* Master Visual Specimen Display Placeholder */}
        ...
        {/* RIGHT COLUMN: The Metadata Specimen Ledger (5 Columns) */}
